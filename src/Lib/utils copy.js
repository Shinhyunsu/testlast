...
const coinReadDataUtils = {
    mixExchangeUpdates: (one_names, two_names, three_names, all_coin, state) => {
        ...
        two_names.forEach(name => {
            ...
            if (moneySym === "KRW") {
                if (sortOrder[0] === 'upbitSym') {
                    calper = ((nowPrice - parseFloat(coinStateDatas[shortSym].upbitKRWPrice)) / nowPrice * 100).toFixed(2)
                }
        ...
        one_names.forEach(name => {
            ...
            if (moneySym === "KRW") {
                ...
                */
                ...
                var origin = parseFloat(coinStateDatas['BTC'].upbitKRWPrice);
                cal = (origin * parseFloat(nowPrice)).toFixed(2);
                /*
            ...
            if (coinStateDatas['BTC'].upbitKRWPrice) {
                //@
                var upbitusdtkrw = (coinStateDatas['BTC'].upbitKRWPrice / coinStateDatas['BTC'].upbitUSDTPrice).toFixed(1);
        ...
        three_names.forEach(name => {
            ...
            if (moneySym === 'BTC') {
                cal = (parseFloat(coinStateDatas['BTC'].upbitKRWPrice) * parseFloat(nowPrice)).toFixed(1)
                /*
                                if (sortOrder[0] === 'upbitBTC')
        ...
        Object.keys(coinStateDatas).forEach((coin) => {
            ...
            keyread.forEach((name) => {
                var price;
                if (name === 'upbitKRWPrice') {
                    price = parseFloat(coinStateDatas[coin].upbitKRWPrice);
                ...
                keyread.forEach((name) => {
                    if (name === 'upbitKRWPrice') {
                        dataFactory[arrCount] = {
                            ...
                            'exchange': 'upbit',
                            'OriginPrice': coinStateDatas[coinOne].upbitKRWPrice,
                            'KrwPrice': coinStateDatas[coinOne].upbitKRWPrice
